...
const visualizarContatoCompletoResolver: ResolveFn<VisualizarCompletaContatoView> = (
  route: ActivatedRouteSnapshot
) => {
  return inject(ContatosService).selecionarContatoCompleto(
    route.paramMap.get('id')!
  );
};
...
const routes: Routes = [
  ...
  },
  {
    ...
    resolve: { contato: visualizarContatoCompletoResolver },
  },
];
